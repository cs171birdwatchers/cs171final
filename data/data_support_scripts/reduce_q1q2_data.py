#!/usr/bin/env python3
"""
Reduce temp_grid_daily_2023_q1q2.csv by 50% while maintaining temporal and geographic distribution.
"""
...
def reduce_q1q2_data():
    """Reduce q1q2 data by 50% with even spatial and temporal distribution."""
    data_dir = os.path.dirname(os.path.abspath(__file__))
    input_file = os.path.join(data_dir, 'temp_grid_daily_2023_q1q2.csv')
    output_file = os.path.join(data_dir, 'temp_grid_daily_2023_q1q2.csv')
    temp_output = os.path.join(data_dir, 'temp_grid_daily_2023_q1q2.csv.tmp')
    
    print("Analyzing temp_grid_daily_2023_q1q2.csv structure...")
    
    # Group data by spatial-temporal bins
